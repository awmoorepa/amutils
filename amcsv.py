...
class StringStream:
    ...
    def next_character(self) -> Union[tuple[None, bool], tuple[ambasic.Character, bool]]:
        if self.m_end_of_file:
            return None, False
        else:
...
def next_csv_row_output(ss: StringStream) -> Union[
        tuple[None, ambasic.Errmess, NextRowStatus], tuple[amarrays.Strings, ambasic.Errmess, NextRowStatus]]:
    cs = csv_reader_start()
...
def strings_array_from_string_stream_csv(sts: StringStream) -> Union[
        tuple[None, ambasic.Errmess], tuple[amarrays.StringsArray, ambasic.Errmess]]:
...
def strings_array_from_strings_csv(ss: amarrays.Strings) -> Union[tuple[None, ambasic.Errmess], tuple[amarrays.StringsArray, ambasic.Errmess]]:
